    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          return _context.a(2);
        case 1:
          ui.exploitScreen.scrollIntoView({
            block: 'end'
          });
          // clear terminal
        ...
        case 2:
          ...
          _t = true;
          _context.n = _t === (fwVersion >= 6.70 && fwVersion <= 6.72) ? 3 : _t === (fwVersion >= 7.00 && fwVersion <= 9.60) ? 9 : 10;
          break;
        case 3:
          log("Starting 6.72 Exploit");

          // Initialize Feyzee's expected global result tracking
          window.entrypoint672_result = 0;
          window.exploitsetup672_result = 0;
          _context.p = 4;
          xhr = new XMLHttpRequest();
          xhr.open('GET', './includes/js/exploits/672entrypoint.js', false);
          xhr.send('');
          if (!(xhr.status === 200)) {
            _context.n = 5;
            break;
          ...
          break;
        case 5:
          log("Failed to fetch 6.72 entrypoint file.", "red");
          return _context.a(2);
        case 6:
          _context.n = 8;
          break;
        case 7:
          _context.p = 7;
          _t2 = _context.v;
          log("Error executing entrypoint: " + _t2, "red");
          return _context.a(2);
        case 8:
          badHoistJailbreak();
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          log("Loading optimized chain architecture...");
          _context2.p = 1;
          _context2.n = 2;
        ...
        case 2:
          if (typeof doJailBreak === "function") {
            ...
            log("Error: doJailBreak is not globally defined in bundle.js", "red");
          }
          _context2.n = 4;
          break;
        case 3:
        ...
        case 4:
          ...
          break;
        case 5:
          log("Loading alternative alert wrapper...");
          _context2.p = 6;
          _context2.n = 7;
        ...
        case 8:
          _context2.p = 8;
          _t4 = _context2.v;
          log("Alternative alert module asset not available.", "red");
        case 9:
...
function _Loadpayloads() {
  _Loadpayloads = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(payload, name, payloadId) {
    var inputIp, targetFunc, payloadFile, _t5;
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        ...
        case 10:
          _context5.p = 10;
          _t5 = _context5.v;
          alert('Failed to load payload: ' + payload + " | Error: " + _t5);
        case 11:
          return _context5.a(2);
      }
    }, _callee5, null, [[3, 10]]);
...
function loadSecondLapse() {
  // Hide exploit chains for 6.7x
  if (user.ps4Fw >= 6.70 && user.ps4Fw <= 6.72) {
    document.getElementById('chooseExploitChain').remove();
    return;
  }
  document.querySelector("input[name=\"exploitChain\"][value=\"".concat(user.secondLapse, "\"]")).checked = true;
}
